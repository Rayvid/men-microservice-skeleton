...
exports.up = function (knex, Promise) {
    return knex.schema.createTable('wallets', (table) => {
        ...
        table.string('metadata', 65535).comment('Any additional internal data about record, preferably JSON').notNullable();
        ...
        return knex('wallets')
            .insert({
                ...
                metadata: '{"blockchain_address": 10, "account_type": "Master lympo wallet", "reference_account_id": null}'
            });
    }).then(function () {
